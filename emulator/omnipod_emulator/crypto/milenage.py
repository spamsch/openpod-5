...
during pairing).  The OP constant defaults to the value used by the
OmniBLE open-source implementation (``cdc202d5123e20f62b6d676ac72cb318``).
...
# Default OP constant for Omnipod BLE (from OmniBLE open-source project).
OMNIPOD_OP = bytes.fromhex("cdc202d5123e20f62b6d676ac72cb318")

# Default AMF constant for Omnipod BLE (from OmniBLE open-source project).
OMNIPOD_AMF = bytes.fromhex("b9b9")
