...
- `docs/eap-aka-session-establishment-v6.9.8.md` summarizes what the
  phone-side implementation in app v6.9.8 actually accepts during
  session establishment and which earlier emulator assumptions turned
  out to be wrong.
